...
(() => {
	...
	const STRINGS = {
		pt: {
			...
			"kt-grelha-desc": "Gera o tecido urbano. Pinta-se a malha em 2D — lotes, ruas, blocos — e o motor reconstrói a cidade em 3D.",
			"kt-grelha-b1": "malha procedural",
			...
			"m-cyanga": "1º lugar Indigitous Beira 2020 — Melhor Tecnologia & Inovação. Hoje integrado no Fonte da Vida.",
			"m-learn": "Plataforma para aprender inglês através de histórias e tópicos de interesse. Foco em falantes de birmanês. Pré-lançamento.",
			"st-wip": "em dev",
		...
		en: {
			...
			"kt-grelha-pill": "layout · 2D → 3D",
			"kt-grelha-desc": "Lays out the urban fabric. You paint the mesh in 2D — lots, streets, blocks — and the engine rebuilds the city in 3D.",
			"kt-grelha-b1": "procedural mesh",
			...
			"m-cyanga": "1st place Indigitous Beira 2020 — Best Tech & Innovation. Now merged into Fonte da Vida.",
			"m-learn": "Learn English through stories and topics that interest you. Built for Burmese speakers. Pre-launch.",
			"st-wip": "in dev",
